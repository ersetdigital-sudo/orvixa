...
const GAMES = [
  ...
  { href: "/magic-chess-go-go", src: "https://res.cloudinary.com/dqjh7utdb/image/upload/v1788148894/aj4q0rohtu1mfvalbtob.webp", alt: "Top up Magic Chess Go Go token murah", badge: "Baru", badgeStyle: { background: "rgba(43,196,160,.16)", color: "#5AE0BF", border: "1px solid rgba(43,196,160,.35)" }, name: "Magic Chess: Go Go", publisher: "Moonton", item: "Token", price: "Rp3.500", cat: "topup" },
