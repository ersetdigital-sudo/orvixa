...
const POPULAR_GAMES = [
  ...
  { href: "/pubg-mobile", src: "https://res.cloudinary.com/dqjh7utdb/image/upload/v1788151891/mngzis7bhlj3rihx5pee.png", alt: "Top up PUBG Mobile UC", name: "PUBG Mobile", publisher: "Tencent Games", gradient: "linear-gradient(135deg, #2050a0 0%, #3060c0 100%)" },
  { href: "/free-fire", src: "https://res.cloudinary.com/dqjh7utdb/image/upload/v1788151808/fceguvbxqtm2hqlotcro.png", alt: "Top up Free Fire diamond", name: "Free Fire", publisher: "Garena", gradient: "linear-gradient(135deg, #803050 0%, #a04060 100%)" },
