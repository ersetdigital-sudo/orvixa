...
const OTHER_GAMES = [
  ...
  { href: "/pubg-mobile", src: "https://res.cloudinary.com/dqjh7utdb/image/upload/v1788151891/mngzis7bhlj3rihx5pee.png", alt: "Top up PUBG Mobile", name: "PUBG Mobile", publisher: "Tencent", item: "UC" },
